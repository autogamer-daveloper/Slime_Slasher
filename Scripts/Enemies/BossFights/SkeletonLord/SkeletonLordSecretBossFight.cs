...
public class SkeletonLordSecretBossFight : MonoBehaviour
{
    ...
    [SerializeField] private string bossKey = "isSkeletonLordHardDefeated";
    [Header("__ UI __")]
    ...
    private float _afterCoilSpawns = 4f;
    ...
    private void _SpawnCoils()
    {
        ...
        else
        {
            ...
            if (_coilCount <= 5) { Invoke(nameof(_SpawnCoils), _betweenCoilSpawns); }
            else { Invoke(nameof(SpawnEnemy), _afterCoilSpawns); }
        }
